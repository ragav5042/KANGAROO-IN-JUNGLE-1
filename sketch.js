...
*/
kangaroo=createSprite(450,380,50,50)
kangaroo.scale=0.1
kangaroo.addAnimation("kang",kangaroo_running )
kangaroo.addAnimation("kangaroo",kangaroo_collided)
kangaroo.debug=true
kangaroo.setCollider("circle",0,0,300)
invisibleGround=createSprite(400,390,800,50)
...
//In function draw(), Set the x-Position of the kangaroo according to the camera    
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    kangaroo.changeAnimation("kangaroo",kangaroo_collided);
...
function spawnShrubs() {
  ...
  if (frameCount % 150 === 0) {
shrub=createSprite(camera.position.x+400,330)
